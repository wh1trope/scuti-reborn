package me.noxerek.scuti;

import me.noxerek.scuti.configuration.Configuration;
import me.noxerek.scuti.configuration.io.Parser;
import me.noxerek.scuti.exception.ClassNotFoundException;
import me.noxerek.scuti.rewrite.CustomWriter;
import me.noxerek.scuti.rewrite.Hierarchy;
import me.noxerek.scuti.transform.Transformer;
import me.noxerek.scuti.transform.Transformers.Obfuscation;
import me.noxerek.scuti.transform.Transformers.Optimization;
import me.noxerek.scuti.transform.Transformers.Shrinking;
...
public class Scuti {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Scuti.class);
    ...
    public static void main(final String[] args) {
        System.out.println("Scuti java obfuscator, written by netindev, remaster by Noxerek V: " + Scuti.PACKAGE_VERSION);
    ...
    private void init() throws Exception {
        ...
        this.outputStream = new JarOutputStream(Files.newOutputStream(this.configuration.getOutput().toPath()));
        jarFile.close();
